...
const String normDaemonMode = "n";

const String createToolTip =
    "Schedule a wallpaper change. Note location must be set first!";
...
const List<Map<String, String>> allCountryNameToCode = [
